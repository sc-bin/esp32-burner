...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_mode_1.setGeometry(QtCore.QRect(70, 10, 150, 150))
        self.pushButton_mode_1.setObjectName("pushButton_mode_1")
        self.pushButton_mode_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_mode_2.setGeometry(QtCore.QRect(240, 10, 150, 150))
        self.pushButton_mode_2.setObjectName("pushButton_mode_2")
        self.pushButton_mode_3 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_mode_3.setGeometry(QtCore.QRect(50, 170, 351, 81))
        self.pushButton_mode_3.setObjectName("pushButton_mode_3")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_mode_3.setText(_translate("MainWindow", "A|B. 上电时检测进入A或B"))
